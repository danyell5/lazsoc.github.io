        ...
        function ShopifyBuyInit() {
            ...
            if (window.shopifyUIInstance) {
                ...
                try {
                    ...
                    container.id = 'collection-component-1737831923249';
                ...
                shopifyUI.createComponent('collection', {
                    id: '274043371593',
                    node: document.getElementById('collection-component-1737831923249'),
    ...
    return (
        <div className="shopify-page business-formal">
            <div className="shopify-content">
                ...
                <div id="collection-component-1737831923249"></div>
            </div>
            <Footer />
        </div>
    );
