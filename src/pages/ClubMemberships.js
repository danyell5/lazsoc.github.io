        ...
        function ShopifyBuyInit() {
            ...
            if (window.shopifyUIInstance) {
                ...
                try {
                    ...
                    container.id = 'collection-component-1737833183470';
                ...
                shopifyUI.createComponent('collection', {
                    id: '160852934729',
                    node: document.getElementById('collection-component-1737833183470'),
    ...
    return (
        <div className="shopify-page club-memberships">
            <div className="shopify-content">
                ...
                <div id="collection-component-1737833183470"></div>
            </div>
            <Footer />
        </div>
    );
