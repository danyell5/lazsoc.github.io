        ...
        function ShopifyBuyInit() {
            ...
            if (window.shopifyUIInstance) {
                ...
                try {
                    ...
                    container.id = 'collection-component-1737836273904';
                ...
                shopifyUI.createComponent('collection', {
                    id: '160852967497',
                    node: document.getElementById('collection-component-1737836273904'),
    ...
    return (
        <div className="shopify-page merchandise">
            <div className="shopify-content">
                <h1>Merchandise</h1>
                <div id="collection-component-1737836273904"></div>
            </div>
            <Footer />
        </div>
    );
